        ...
        try {
          ...
          //  System.out.println("running lowercase");
           ...
           // String[] args = new String[]{"perl", lowercasePath, "-l", lang};
            ...
            //String[] args = new String[]{"perl",truecaseOptions[0], "--model", truecaseOptions[1],"<","\""+input+"\"",">","\""+tempOut+"\""};
...
//            StreamGobbler outputGobbler = new StreamGobbler(process.getInputStream(), "STDOUT", System.out);
...
//                }
                while(br.ready()){
                    ...
                    if(exitValue!=-1){
                        ...
                        System.out.println("");
                        System.out.println("####################################");
                        System.out.println("PROCESS TERMINATED PREMATURELY: " + exitValue);
                        System.out.println("SENTENCE WHERE IT STOPPED: " + line);
                        System.out.println("####################################");
                        System.out.println("");
                        System.out.println("");
                    }
            ...
            ProcessBuilder pb = new ProcessBuilder(args); //ASDPFOIASDUFPIASDFUPIOSDAFUIPODSPOFUIFDUPSIASAUIPODF
            process = pb.start();
            Logger.log("Executing: " + process.toString());
